...
def format_record(record: dict) -> str:
    ...
    Example:
    >>> payload = [{"users":[{"name": "Nick", "age": 87, "is_active": True}, {"name": "Alex", "age": 27, "is_active": True}],
                    "count": 2}]
...
def replace_log_handlers():
    ...
    >>> app.add_event_handler("startup", replace_log_handlers)
    stdout:
